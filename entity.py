...
class Entity:
    ...
    def move_astar(self, target, entities, game_map):
        ...
        # Scan all the objects to see if there are
        ...
        #  longer paths (for example through other rooms) if for
        #  example the player is in a corridor
        # It makes sense to keep path size relatively low to keep the
